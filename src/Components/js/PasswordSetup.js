/* 
	File name		: PasswordSetup.js
	Purpose			: Corresponds to the New password setup page of the application.
...
function PasswordSetup() {
	...
	const checkPassword = (event) => {
		...
		passwordValuePath = 'userAuthentication/' + usernameValue[0]
 
		database.ref(passwordValuePath).child('password').set(values.password).then().catch();
